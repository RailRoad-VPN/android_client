...
import net.rroadvpn.openvpn.api.ExternalCertificateProvider;
...
public class ExtAuthHelper {
    ...
    public static final String ACTION_CERT_CONFIGURATION = "net.rroadvpn.openvpn.api.ExternalCertificateConfiguration";
    public static final String ACTION_CERT_PROVIDER = "net.rroadvpn.openvpn.api.ExternalCertificateProvider";

    public static final String EXTRA_ALIAS = "net.rroadvpn.openvpn.api.KEY_ALIAS";
    public static final String EXTRA_DESCRIPTION = "net.rroadvpn.openvpn.api.KEY_DESCRIPTION";
