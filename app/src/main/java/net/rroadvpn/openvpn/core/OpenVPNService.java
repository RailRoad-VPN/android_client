...
public class OpenVPNService extends VpnService implements VpnStatus.StateListener, Callback, VpnStatus.ByteCountListener, IOpenVPNServiceInternal {
    ...
    public static final String START_SERVICE_STICKY = "net.rroadvpn.openvpn.START_SERVICE_STICKY";
    public static final String ALWAYS_SHOW_NOTIFICATION = "net.rroadvpn.openvpn.NOTIFICATION_ALWAYS_VISIBLE";
    public static final String DISCONNECT_VPN = "net.rroadvpn.openvpn.DISCONNECT_VPN";
    ...
    private static final String PAUSE_VPN = "net.rroadvpn.openvpn.PAUSE_VPN";
    private static final String RESUME_VPN = "net.rroadvpn.openvpn.RESUME_VPN";
...
//    }
    ...
    synchronized void unregisterDeviceStateReceiver() {
        if (mDeviceStateReceiver != null)
            try {
                ...
                // java.lang.IllegalArgumentException: Receiver not registered: net.rroadvpn.openvpn.NetworkSateReceiver@41a61a10
                // Ignore for now ...
                iae.printStackTrace();
            }
    ...
    private OpenVPNManagement instantiateOpenVPN3Core() {
        try {
            Class cl = Class.forName("net.rroadvpn.openvpn.core.OpenVPNThreadv3");
...
//        builder.setConfigureIntent(getGraphPendingIntent());
    ...
    private void doSendBroadcast(String state, ConnectionStatus level) {
        ...
        vpnstatus.setAction("net.rroadvpn.openvpn.VPN_STATUS");
    ...
    public void updateByteCount(long in, long out, long diffIn, long diffOut) {
        if (mDisplayBytecount) {
            ...
            showNotification(netstat, null, NOTIFICATION_CHANNEL_BG_ID, mConnecttime, ConnectionStatus.LEVEL_CONNECTED);
        }
    ...
    public void requestInputFromUser(int resid, String needed) {
        ...
        showNotification(getString(resid), getString(resid), NOTIFICATION_CHANNEL_NEWSTATUS_ID, 0, ConnectionStatus.LEVEL_WAITING_FOR_USER_INPUT);
    }
