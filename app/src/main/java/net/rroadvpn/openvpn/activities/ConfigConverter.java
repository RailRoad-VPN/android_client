...
import net.rroadvpn.openvpn.fragments.Utils;
import net.rroadvpn.openvpn.views.FileSelectLayout;
...
public class ConfigConverter extends BaseActivity implements FileSelectLayout.FileSelectCallback, View.OnClickListener {
    ...
    public static final String IMPORT_PROFILE = "net.rroadvpn.openvpn.IMPORT_PROFILE";
