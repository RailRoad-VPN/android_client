...
import net.rroadvpn.openvpn.fragments.Settings_Allowed_Apps;
import net.rroadvpn.openvpn.fragments.Settings_Authentication;
import net.rroadvpn.openvpn.fragments.Settings_Basic;
import net.rroadvpn.openvpn.fragments.Settings_IP;
import net.rroadvpn.openvpn.fragments.Settings_Obscure;
import net.rroadvpn.openvpn.fragments.Settings_Routing;
import net.rroadvpn.openvpn.fragments.Settings_UserEditable;
import net.rroadvpn.openvpn.fragments.ShowConfigFragment;
import net.rroadvpn.openvpn.fragments.VPNProfileList;
import net.rroadvpn.openvpn.views.ScreenSlidePagerAdapter;
import net.rroadvpn.openvpn.views.TabBarView;

import net.rroadvpn.openvpn.R;

import net.rroadvpn.openvpn.fragments.Settings_Connections;
