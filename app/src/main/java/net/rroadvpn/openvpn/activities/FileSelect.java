...
import net.rroadvpn.openvpn.fragments.FileSelectionFragment;
import net.rroadvpn.openvpn.fragments.InlineFileTab;
...
public class FileSelect extends BaseActivity {
	...
	public static final String NO_INLINE_SELECTION = "net.rroadvpn.openvpn.NO_INLINE_SELECTION";
	public static final String SHOW_CLEAR_BUTTON = "net.rroadvpn.openvpn.SHOW_CLEAR_BUTTON";
	public static final String DO_BASE64_ENCODE = "net.rroadvpn.openvpn.BASE64ENCODE";
