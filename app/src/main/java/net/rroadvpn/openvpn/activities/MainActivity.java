...
import net.rroadvpn.openvpn.fragments.AboutFragment;
import net.rroadvpn.openvpn.fragments.FaqFragment;
...
import net.rroadvpn.openvpn.views.SlidingTabLayout;
