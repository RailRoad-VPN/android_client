...
import net.rroadvpn.openvpn.activities.LogWindow;
...
public class LaunchVPN extends Activity {
    ...
    public static final String EXTRA_KEY = "net.rroadvpn.openvpn.shortcutProfileUUID";
    public static final String EXTRA_NAME = "net.rroadvpn.openvpn.shortcutProfileName";
    public static final String EXTRA_HIDELOG = "net.rroadvpn.openvpn.showNoLogWindow";
