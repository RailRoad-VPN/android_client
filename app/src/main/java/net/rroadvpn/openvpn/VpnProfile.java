...
import net.rroadvpn.openvpn.core.Connection;
import net.rroadvpn.openvpn.core.ExtAuthHelper;
import net.rroadvpn.openvpn.core.NativeUtils;
import net.rroadvpn.openvpn.core.OpenVPNService;
import net.rroadvpn.openvpn.core.OrbotHelper;
import net.rroadvpn.openvpn.core.PasswordCache;
...
import net.rroadvpn.openvpn.core.X509Utils;
...
public class VpnProfile implements Serializable, Cloneable {
    ...
    public static final String EXTRA_PROFILEUUID = "net.rroadvpn.openvpn.profileUUID";
